      ...
      <div className="PubCrawlDetail">
        ...
        <div className="containerMap">
          ...
          <div className="card-body pub-detail" >
            <h3 className="black-color font-w " >Pub Crawl Details</h3>
            {/* <JoinBtn /> */}
            <br />
          ...
          < hr />
            ...
            <div className="card-body  pub-detail">
              <h3 className="black-color font-w ">Places/ Routes </h3>
              <br />
              <h5 scope="col"></h5>
              ...
              <Link to={`/edit-pubCrawl/${this.state.pubCrawl._id}`} className="btns size-btn text-alg" >Edit</Link>
              </div>
            </div >
          </div>
        </div>
